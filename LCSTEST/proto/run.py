...
import unittest
import time
from LCSTEST.proto import HTMLTestRunner
import time
import os
import smtplib
...
def send_email(newfile):
    ...
    # 发送邮箱用户名/密码
    user = 'veron@91fifa.com'
    password = '211314yoU'
    # 发送邮箱
    sender = 'veron@91fifa.com'
    # 多个接收邮箱，单个收件人的话，直接是receiver='XXX@126.com'
    receiver = ['veron@91fifa.com','monica.zhu@91fifa.com']
    # 发送邮件主题
    subject = '自动定时发送LCS接口测试报告'
    ...
    msg['From'] = 'veron@91fifa.com(veron)'
...
if __name__ == '__main__':
    ...
    runner = HTMLTestRunner.HTMLTestRunner(stream=fp, title='LCS接口测试报告', description='测试用例结果')
    runner.run(discover)
